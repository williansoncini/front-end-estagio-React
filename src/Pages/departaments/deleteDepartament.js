...
import { deleteDepartament, getDepartament } from "../services/departaments/departamentsService"

export default function DeleteDepartament() {
    const { id } = useParams()
    ...
    useEffect(async function () {
        ...
        if (response.status == 200) {
            ...
            setValue('ativo', data.ativo_descricao)
        }
    }, [])
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} id='form-create-table'>
                        <div className='create-user-container'>
                            ...
                            <div className='itens'>
                                ...
                                <InputTextDisabled register={register} name='ativo' label='Status*:' errors={errors} />
                            </div>
                        </div>
