...
const UpdateTable = function () {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            return updateToast(id_toast_update_table, 'error', 'Erro na alteração da tabela')
        }
        ...
        try {
            ...
            return updateToast(id_toast_update_columns, 'error', 'Erro na alteração da tabela')
        }
        ...
        if (nome_colunas.length > 0) {
            ...
            try {
                ...
                return updateToast(id_toast_create_columns, 'error', 'Erro na alteração da tabela')
            }
        }
    }
